...
const pageUrl = "https://www.ukinboundgroundtransport.com/markets/india";

export const metadata: Metadata = {
  title: "India Market | UK Inbound Ground Transport",
  description:
    "Specialist UK & Ireland ground transport support for Indian travel companies, operators and planners. Fixed-departure touring, private groups, cruise port support, London movements and multi-region itineraries.",
  keywords: [
    "UK transport for Indian tour operators",
    "UK inbound transport India market",
    "UK and Ireland touring transport India",
    "UK DMC transport support",
    "UK group transport logistics",
    "cruise port transport UK",
  ],
  alternates: {
    canonical: "/markets/india",
  },
  openGraph: {
    title: "India Market | UK Inbound Ground Transport",
    description:
      "Programme-led UK & Ireland transport support for Indian travel partners.",
    url: pageUrl,
...
const supportItems = [
  "Private group touring and tailored itineraries",
  "Fixed-departure series and escorted touring",
...
const sectors = [
  {
    title: "Travel companies and operators",
    text: "Structured transport support for premium itineraries, escorted touring and wider UK & Ireland group programmes serving the India market.",
  },
  {
    title: "DMCs and receptive partners",
    text: "Clear routing, dependable movement planning and operational delivery aligned to the structure and pace of inbound itineraries.",
  },
  {
    title: "Private group specialists",
    text: "Tailored support for customised group itineraries requiring flexibility, timing control and dependable programme flow.",
  },
  {
...
const indiaJsonLd = {
  ...
  "@type": "Service",
  name: "UK and Ireland ground transport support for Indian travel partners",
  provider: {
    "@type": "Organization",
  ...
  areaServed: ["India", "United Kingdom", "Ireland"],
  serviceType: [
    ...
    <main>
      ...
      <section style={heroSection}>
        <div style={containerNarrow}>
          <p style={eyebrow}>India</p>

          <h1 style={heroTitle}>
            UK &amp; Ireland transport support for Indian travel companies,
          ...
          <p style={heroText}>
            We support Indian travel partners with programme-led ground
      ...
      <section style={section}>
        <div style={container}>
          <div style={splitGrid} className="split-grid">
            <div>
              <p style={sectionLabel}>India market focus</p>
              <h2 style={sectionTitle}>
                Built for structured UK and Ireland programmes serving Indian
                travellers.
              </h2>
            </div>
            ...
            <div>
              <p style={sectionText}>
                We work with Indian travel companies, operators and planners who
                need transport support that fits a wider operational plan. Our
                role is to align routing, timings and delivery to the structure
                of the programme, helping transport strengthen the itinerary as
                a whole.
              </p>
            </div>
          </div>
      ...
      <section style={sectionSoft}>
        <div style={container}>
          <div style={splitGrid} className="split-grid">
            ...
            <div>
              <p style={sectionText}>
                UK and Ireland itineraries for Indian clients often involve
      ...
      <section style={ctaSection}>
        <div style={containerNarrow}>
          ...
          <h2 style={ctaTitle}>
            Planning a UK or Ireland programme for Indian clients?
          </h2>
